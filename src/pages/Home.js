      ...
      <div className="row align-items-center home1">
        ...
        <div className="col-md-6 text-center home_1">
          ...
          <div className="button_class d-flex justify-content-center">
            <a href="https://drive.google.com/file/d/16bZn6VbnzaLSGKNkc7ZyEu9AFbd-XXeX/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn_1">VIEW CV</button> </a>
          </div>
        </div>
        <div className="col-md-6">
